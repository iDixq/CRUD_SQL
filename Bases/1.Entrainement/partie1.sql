...
SELECT nom, prenom, service, date_embauche FROM employes WHERE date_embauche BETWEEN "2010-01-01" AND "2021-03-16";
...
---------------------------------- -- CHAP 7 -- ------------------------------
------ -- AFFICHER LES PRENOM DES EMPLOYES QUI COMMENCE PAR UN S -- ----------
------------------------------------------------------------------------------
-- USE WHERE WITH LIKE
...
---------------------------------- -- CHAP 8 -- ---------------------------------
------ -- AFFICHER LES PRENOM DES EMPLOYES QUI SE TERMINE PAR UN IE -- ----------
---------------------------------------------------------------------------------
-- USE WHERE WITH LIKE
...
--------------------------------------------- -- CHAP 09 -- ----------------------------------------
------ -- AFFICHER LES PRENOM DES EMPLOYES QUI CONTIENT IE (début, fin ou milieu) -- ---------------
----------------------------------------------------------------------------------------------------
-- USE WHERE WITH LIKE
...
--------------------------------------------- -- CHAP 10 -- -------------------------------------------------------
------ -- AFFICHER LE NOM, PRENOM ET SERVICE DES EMPLOYES QUI NE SONT PAS DU SERVICE INFORMATIQUE  -- ------------
------------------------------------------------------------------------------------------------------------------
...
--------------------------------------------- -- CHAP 11 -- ------------------------------------------------------
---------------------------- -- AFFICHER LES SALAIRES SUPERIEUR A 3000  -- --------------------------------------
-----------------------------------------------------------------------------------------------------------------
-- USE OPERATOR WHITE WHERE
-- >  Strictement supérieur à
-- <  Strictement inférieur à 
...
SELECT salaire FROM employes WHERE salaire > 3000;
...
--------------------------------------------- -- CHAP 13 -- ------------------------------------------------------
------------------------- -- AFFICHER LES EMPLOYES PAR LEUR NOM EN ORDRE DESCENDANT-- ----------------------------
------------------------------------------------------------------------------------------------------------------
-- USE ORDER BY 
...
--------------------------------------------- -- CHAP 14 -- ------------------------------------------------------
------- -- AFFICHER LES COLONNES NOM PRENOM & SALAIRE ORDONNER PAR SALAIRE PUI PAR PRENOM -- ---------------------
------------------------------------------------------------------------------------------------------------------
-- USE ORDER BY
...
--------------------------------------------- -- CHAP 15 -- ------------------------------------------------------
------------- -- ORDONNER LES PRENOMS EN DESCENEDANT PUIS AFFICHER LES TROIS PREMIERE LIGNES -- ------------------
------------------------------------------------------------------------------------------------------------------
-- USE ORDER BY
-- USE LIMIT
...
--------------------------------------------- -- CHAP 16 -- ------------------------------------------------------
-------------------------- -- AFFICHER LES SALAIRES ANNUEL DE CHAQUE EMPLOYES -- ---------------------------------
------------------------------------------------------------------------------------------------------------------
-- USE OPERATOR *
-- USE AS (ALIAS)
...
--------------------------------------------- -- CHAP 17 -- --------------------------------------------------------
-------------------------- -- AFFICHER LA MASSE SALARIAL ANNUEL DE L'ENTREPRISE  -- --------------------------------
--------------------------------------------------------------------------------------------------------------------
-- USE SUM()
-- USE AS (ALIAS)
...
--------------------------------------------- -- CHAP 20 -- -----------------------------------------------------
----------------------- -- ARRONDIR A L'ENTIER LE SALAIRE MOYEN DES INFORMATICIENS -- ---------------------------
-----------------------------------------------------------------------------------------------------------------
-- USE ROUND()
-- USE AVG()
-- USE AS (ALIAS)
...
--------------------------------------------- -- CHAP 21 -- -----------------------------------------------------
---------------- -- ARRONDIR AVEC DEUX DECIMALES LE SALAIRE MOYEN DES INFORMATICIENS -- -------------------------
-----------------------------------------------------------------------------------------------------------------
-- USE ROUND()
-- USE AVG()
-- USE AS (ALIAS)
...
SELECT ROUND(AVG(salaire), 2) AS salaire_moyen FROM employes WHERE service = "informatique";
...
--------------------------------------------- -- CHAP 22 -- -----------------------------------------------------
--------------------- -- AFFICHER LE NOMBRE D HOMME & DE FEMME DANS L'ENTREPRISE -- -----------------------------
-----------------------------------------------------------------------------------------------------------------
-- USE COUNT()
-- USE AS (ALIAS)
-- WHERE
...
SELECT 
(SELECT COUNT(*) FROM employes WHERE sexe = "m") as HOMME,
(SELECT COUNT(*) FROM employes WHERE sexe = "f") as FEMME;
...
--------------------------------------------- -- CHAP 23 -- -----------------------------------------------------
-------------------------------- -- AFFICHER LE SALAIRE LE PLUS BAS  -- -----------------------------------------
-----------------------------------------------------------------------------------------------------------------
-- USE MIN()
-- USE AS (ALIAS)

SELECT MIN(salaire) AS plus_bas_salaire FROM employes;
...
--------------------------------------------- -- EXERCICE 25 -- -------------------------------------------------
-------------------------- -- AFFICHER LE SALAIRE MINIMUM AVEC LE NOM & PRENOM -- -------------------------------
-----------------------------------------------------------------------------------------------------------------
-- USE ORDER BY (pas besoin du ORDER BY)
